    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md">
        ...
        <div className="flex-1">
          ...
          <UmlautToolbar targetRef={searchRef} className="mt-2" />
        </div>
        ...
        <div className="min-w-[180px]">
          <select
            ...
            className="w-full h-12 px-4 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all cursor-pointer"
          >
