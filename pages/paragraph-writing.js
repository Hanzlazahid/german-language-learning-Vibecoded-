...
export default function ParagraphWritingPage() {
  ...
  return (
    <>
      <Head>
        <title>German Learning App - Paragraph Writing</title>
      </Head>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="flex items-center justify-center gap-3 text-4xl sm:text-5xl font-bold text-gray-800 dark:text-white mb-3">
            ...
            <span>Paragraph Writing</span>
          </h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Practice writing in German and see real-time English translations
          </p>
        </div>
